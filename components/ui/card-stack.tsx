                        ...
                        {items.map((item, i) => {
                            ...
                            return (
                                <motion.div
                                    key={item.id}
                                    className={cn(
                                        "absolute bottom-0 rounded-xl border border-black/10 dark:border-white/10 overflow-hidden shadow-xl",
                ...
                <div className="mt-6 flex items-center justify-center gap-3">
                    ...
                    {activeItem.href ? (
                        <Link
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="text-muted-foreground hover:text-foreground transition z-50 pointer-events-auto"
    ...
    return (
        <div className="relative h-full w-full">
            ...
            <div className="relative z-10 flex h-full flex-col justify-end p-6">
                {item.tag && (
                    <div className="mb-1 text-[10px] font-bold uppercase tracking-[0.2em] text-[#C3E41D]">
                        {item.tag}
                    </div>
                )}
                ...
                {item.description ? (
                    <div className="line-clamp-2 text-sm text-zinc-300 mb-4 leading-relaxed" style={{ fontFamily: "'Antic', sans-serif" }}>
                        {item.description}
                    </div>
                ) : null}
                {item.href && (
                    <Link
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="inline-flex items-center gap-2 text-xs font-bold text-white hover:text-[#C3E41D] transition-colors group/cta"
                        onClick={(e) => e.stopPropagation()}
                    >
                        <span className="border-b border-transparent group-hover/cta:border-[#C3E41D] pb-0.5">
                            {item.ctaLabel || "Launch App"}
                        </span>
